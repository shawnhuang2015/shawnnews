...
goog.exportSymbol('proto.helloworld.HelloReplyAgain', null, global);
 ...
 * @constructor
 */
proto.helloworld.HelloReplyAgain = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.helloworld.HelloReplyAgain, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.helloworld.HelloReplyAgain.displayName = 'proto.helloworld.HelloReplyAgain';
}
 ...
 * @return {!Object}
 */
proto.helloworld.HelloReplyAgain.prototype.toObject = function(opt_includeInstance) {
  return proto.helloworld.HelloReplyAgain.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.helloworld.HelloReplyAgain} msg The msg instance to transform.
 * @return {!Object}
 */
proto.helloworld.HelloReplyAgain.toObject = function(includeInstance, msg) {
  var f, obj = {
    message: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.helloworld.HelloReplyAgain}
 */
proto.helloworld.HelloReplyAgain.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.helloworld.HelloReplyAgain;
  return proto.helloworld.HelloReplyAgain.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.helloworld.HelloReplyAgain} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.helloworld.HelloReplyAgain}
 */
proto.helloworld.HelloReplyAgain.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.helloworld.HelloReplyAgain.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.helloworld.HelloReplyAgain.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.helloworld.HelloReplyAgain} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.helloworld.HelloReplyAgain.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getMessage();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.helloworld.HelloReplyAgain.prototype.getMessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.helloworld.HelloReplyAgain.prototype.setMessage = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.helloworld.HelloReplyAgain.prototype.getTest = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.helloworld.HelloReplyAgain.prototype.setTest = function(value) {
