...
angular.module('cipApp').factory('CrowdManager', ['$resource',
    function($resource) {
        return $resource('/api/crowdSingle/crowd/:crowdName', {
            crowdName: '@crowdName'
        }, {
            update: {
                method: 'PUT'
...
angular.module('cipApp').factory('CrowdService', ['$http',
    function($http) {
        var createCrowd = function(crowd, callback) {
            $http.post('/api/crowdSingle/crowd',crowd).
        ...
        var getCount = function(callback) {
            ...
            $http.get('/api/crowdSingle/crowdcount').
            success(function(data, status, headers, config) {
                callback({
                    success: !data.error,
