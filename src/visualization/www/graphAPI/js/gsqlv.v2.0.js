    ...
    */
    ...
    for (var link in selectedEdges) {
      ...
      linkItem += '<tr name="element_name" onclick="onClick_table_head(this,\'link\',\''
        ...
        '\')"><td style="color: #fff;background-color: #5bc0de;border-color: #46b8da;width:25%">Element Name</td><td style="width:75%"> link:'+link.source.id+'=>'+link.target.id+'</td></tr>';
  ...
  */
  ...
  function refineDataName(newData) {
    ...
    newData.edges.forEach(function(e) {
      ...
      tempEdge.attr = topology4VertexAttribute_to_json(e.attr)
    ...
    if (vattr == "") {
      ...
      attrs.forEach(function(attr, i) {
        ...
        if (items.length > 1 && items[0] != "" && items[1] != "") {
          ...
          result[items[0].replace(')', '').replace('(', '_')] = items[1];
        }
      })
      return result; 
    }
