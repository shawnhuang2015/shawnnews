...
//                               location:{count:true},
//                               enterprise:{group_count:true, count:true, name:true},
//                               warning:{is_warning:false},
//                               phone_no:{importance:true},
//                               reason:{reason:true},
//                               level:{complaint_count:true}
//                             }, 
//                           edge:{type:true, id:false}
//                           }; // node:{type:boolean, attr1:boolean, attr2:boolean ...}
...
//         var tabname = window.pages_obj[i].tabname;
//         var removedSpaces = removeSpaces(tabname);
//         tabline = '<li><a href="#" id="' + removedSpaces  + '" name="'+removedSpaces+'_'+ i + '">' + toLanguage(tabname) + '</a></li>';
...
//   // remove space function.
//   windows.removeSpaces = function(s) {
//     return s.replace(/\s/g, '');
//   }
...
//   this.updateQueryInputInfoBox = function(payload, page_index) {
//     var table = "<h3>"+window.pages_obj[page_index]['tabname']+"</h3>"
//     if (typeof payload != 'object' || Object.keys(payload).length >= 0) {
//       //return;
//     }
//     else {
