...
namespace lianlian_score_viz_ns {
  ...
  // UDF definition
  class FraudScoreVizUDF : public gpelib4::BaseUDF {
    private:
    ...
    public:
      ...
      FraudScoreVizUDF(int iteration_limit, VertexLocalId_t source, gutil::JSONWriter* writer = NULL)
