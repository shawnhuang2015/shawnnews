...
CREATE LOADING JOB lianlianLoad FOR GRAPH lianlian
  LOAD "/home/ec2-user/data/graphdata-sample-fraudadded.csv" TO VERTEX transaction VALUES($0,reduce(OR(IsNotNull($5)))),
  ...
  LOAD "/home/ec2-user/data/graphdata-sample-fraudadded.csv" TO EDGE transToEntity VALUES($0, $8) WHERE NotNull($8)
       USING HEADER="true", SEPARATOR=",", FROM="transaction", TO="userId";
  LOAD "/home/ec2-user/data/graphdata-sample-fraudadded.csv" TO EDGE transToEntity VALUES($0, $14) WHERE IsSSNIDTypeAndNotNull($15,$14)
       USING HEADER="true", SEPARATOR=",", FROM="transaction", TO="ssn";
  LOAD "/home/ec2-user/data/graphdata-sample-fraudadded.csv" TO EDGE transToEntity VALUES($0, $10) WHERE NotNull($10)
       USING HEADER="true", SEPARATOR=",", FROM="transaction", TO="bankId";
  LOAD "/home/ec2-user/data/graphdata-sample-fraudadded.csv" TO EDGE transToEntity VALUES($0, $13) WHERE NotNull($13)
       USING HEADER="true", SEPARATOR=",", FROM="transaction", TO="cell";
  LOAD "/home/ec2-user/data/graphdata-sample-fraudadded.csv" TO EDGE transToEntity VALUES($0, $19) WHERE NotNull($19)
       USING HEADER="true", SEPARATOR=",", FROM="transaction", TO="imei";
  LOAD "/home/ec2-user/data/graphdata-sample-fraudadded.csv" TO EDGE transToEntity VALUES($0, $17) WHERE NotNull($17)
